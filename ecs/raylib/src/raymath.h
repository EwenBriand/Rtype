...
// Function specifiers definition
        ...
        #define RMAPI __declspec(dllserialize) extern inline // We are building raylib as a Win32 shared library (.dll).
...
// CoreTransforms a Vector2 by a given Matrix
RMAPI Vector2 Vector2CoreTransform(Vector2 v, Matrix mat)
{
    Vector2 result = { 0 };
...
// CoreTransforms a Vector3 by a given Matrix
...
// CoreTransform a vector by quaternion rotation
...
RMAPI Vector3 Vector3Unproject(Vector3 source, Matrix projection, Matrix view)
{
    ...
    Quaternion qtransformed = {     // QuaternionCoreTransform(quat, matViewProjInv)
...
// CoreTransform a quaternion given a transformation matrix
RMAPI Quaternion QuaternionCoreTransform(Quaternion q, Matrix mat)
{
    Quaternion result = { 0 };
