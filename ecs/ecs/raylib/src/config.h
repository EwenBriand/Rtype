...
#define SUPPORT_MODULE_RTEXT            1       // WARNING: It needs SUPPORT_MODULE_RTEXTURES to load sprite font textures
...
// Support image serialize functionality (.png, .bmp, .tga, .jpg, .qoi)
