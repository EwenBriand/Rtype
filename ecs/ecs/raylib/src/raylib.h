...
typedef enum {
    ...
    FONT_SDF                        // SDF font generation, needs external shader
} FontType;
...
RLAPI void BeginVrStereoMode(VrStereoConfig config);              // Begin stereo rendering (needs VR simulator)
RLAPI void EndVrStereoMode(void);                                 // End stereo rendering (needs VR simulator)
...
RLAPI bool IsAudioStreamProcessed(AudioStream stream);                // Check if any audio stream buffers needs refill
