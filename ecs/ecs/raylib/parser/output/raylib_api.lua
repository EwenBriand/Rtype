return {
  ...
  structs = {
    ...
    {
      name = "CoreTransform",
      description = "CoreTransform, vertex transformation data",
      fields = {
        {
          type = "Vector3",
          name = "translation",
    ...
    },
    {
      ...
      values = {
        ...
        },
        {
          name = "FONT_SDF",
          value = 2,
          description = "SDF font generation, needs external shader"
        }
      }
    },
    {
  ...
  functions = {
    ...
    },
    {
      ...
      description = "Begin stereo rendering (needs VR simulator)",
      returnType = "void",
      params = {
    ...
    },
    {
      ...
      description = "End stereo rendering (needs VR simulator)",
      returnType = "void"
    },
    {
    ...
    },
    {
      ...
      description = "Check if any audio stream buffers needs refill",
      returnType = "bool",
      params = {
        {type = "AudioStream", name = "stream"}
      }
