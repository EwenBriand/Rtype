...
int GLAD_GL_AMD_shader_stencil_serialize = 0;
...
int GLAD_GL_ARB_shader_stencil_serialize = 0;
...
static int find_extensionsGL(void) {
	...
	GLAD_GL_AMD_shader_stencil_serialize = has_ext("GL_AMD_shader_stencil_serialize");
	...
	GLAD_GL_ARB_shader_stencil_serialize = has_ext("GL_ARB_shader_stencil_serialize");
