...
@REM ./build/ecs/run_engine --config-dir=game_rtype/.engine/config --server-port=8080 --server-mode --no-graphics
...
@REM run the engine
%engine_path% --config-dir=%config_dir% --server-port=%port% %server_mode% %no_graphics%
