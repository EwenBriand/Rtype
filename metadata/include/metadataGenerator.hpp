...
namespace meta {
    ...
    private:
        void generateMetadataForFile(const std::string& filepath, const std::string& filename, const std::string& scriptPath);
        ...
        void check_depends(std::vector<std::string>& words, size_t& i, const std::string& scriptPath, const std::string& filepath);
