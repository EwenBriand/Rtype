...
namespace meta {
    ...
    void MetadataGenerator::initCMake()
    {
        ...
        _cmakefile += "include_directories(" + folder + " " + folder + "../../../metadata/include/ ../../metadata/include/ ../../ecs/include/ ../../ecs/raylib/raylib/include/ " + folder + "/../../ecs/raylib/src/)\n";
        ...
        _cmakefile += "\t${CMAKE_CURRENT_SOURCE_DIR}/ecs/raylib/raylib/\n";
        _cmakefile += "\t${CMAKE_CURRENT_SOURCE_DIR}/../ecs/raylib/raylib/\n";
        _cmakefile += ")\n";
    }
