...
/*
** @file Tcemort.hpp
** @brief Definition of the Tcemort class.
...
/**
 * @brief This class is a script to control the Tcemort.
 * It will depend on a controller, to enable controlling the Tcemort
 * from the network, the local player, or the ai.
 *
 */
serialize class Tcemort : public AUserComponent {
public:
    GENERATE_METADATA(Tcemort)
    Tcemort() = default;
    ~Tcemort() = default;
