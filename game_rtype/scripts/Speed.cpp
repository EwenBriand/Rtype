...
/*
** @file Speed.cpp
** @brief Implementation of the Speed class.
...
MANAGED_RESOURCE(Speed)

// ===========================================================================================================
// Component
// ===========================================================================================================

void Speed::OnAddComponent(int entityID)
{
    ...
    _collider->SetOnCollisionEnter([this](int entityID, int otherID) {
        try {
            ...
            if (tag.compare(0, 6, "player") == 0) {
                ...
                std::cout << "Speed::OnCollisionEnter(): " << tag << std::endl;
            }
...
void Speed::Update(int entityID)
{
    ...
    try {
        if ((_core->x < -100 or _core->x > 1920 + 100 or _core->y < -100 or _core->y > 1080 + 100)) {
            SYS.UnregisterEntity(_entity);
            std::cout << "Speed::Update(): out of bounds" << std::endl;
        }
    } catch (std::exception& e) {
